...
///
///
/// @defgroup core_vector jni.Vector3 types
///
/// jni.Vector3 types of two to four components with an exhaustive set of operators.
///
/// @ingroup core
///
///
/// @defgroup core_vector_precision jni.Vector3 types with precision qualifiers
///
/// @brief jni.Vector3 types with precision qualifiers which may result in various precision in term of ULPs
///
